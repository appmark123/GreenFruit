...
class news_pic extends WP_Widget {
	function news_pic() {
		$widget_ops = array( 'classname' => 'widget-pic','description' => __( 'Display posts with big image of any category.', 'cmp' ) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'news-pic-widget' );
		$this->WP_Widget( 'news-pic-widget',theme_name .__( ' - News in Pictures' , 'cmp'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'title' =>__('News in Pictures' , 'cmp'), 'no_of_posts' => '6' , 'cats_id' => '1' , 'posts_order' => 'latest' );
