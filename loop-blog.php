	...
	<?php if ( cmp_get_option('list_style') == 'simple_title') {
		...
		while ( have_posts() ) : the_post();
			...
			<li class="archive-simple">
				<h1>📍<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'cmp' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><i class="icon-angle-right"></i><?php the_title(); ?></a></h1>
