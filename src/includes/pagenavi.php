...
function cmp_pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','cmp');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','cmp');
	$pagenavi_options['last_text'] = __('Last &raquo;','cmp');
	$pagenavi_options['next_text'] = __('&raquo;','cmp');
	$pagenavi_options['prev_text'] = __('&laquo;','cmp');
	$pagenavi_options['dotright_text'] = __('...','cmp');
	$pagenavi_options['dotleft_text'] = __('...','cmp');
