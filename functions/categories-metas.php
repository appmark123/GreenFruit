...
wp_enqueue_script('thickbox');
	echo '<div class="form-field">
		<label for="taxonomy_image">' . __('Image','cmp') . '</label>
		<input type="text" name="taxonomy_image" id="taxonomy_image" value="" />
		<br/>
		<button class="z_upload_image_button button">' . __('Uplaod/Add a image','cmp') . '</button>
	</div>'.z_script();
}
...
function z_edit_texonomy_field($taxonomy) {
	...
	echo '<tr class="form-field">
		<th scope="row" valign="top"><label for="taxonomy_image">' . __('Image','cmp') . '</label></th>
		...
		<button class="z_upload_image_button button">' . __('Uplaod/Add a image','cmp') . '</button>
		<button class="z_remove_image_button button">' . __('Delete image','cmp') . '</button>
		</td>
	</tr>'.z_script();
}
...
function z_taxonomy_columns( $columns ) {
	...
	$new_columns['thumb'] = __('Image','cmp');
...
function z_taxonomy_column( $columns, $column, $id ) {
	if ( $column == 'thumb' )
		$columns = '<span><img src="' . z_taxonomy_image_url($id, TRUE) . '" alt="' . __('Category image','cmp') . '" class="wp-post-image" /></span>';
...
function z_change_insert_button_text($safe_text, $text) {
    return str_replace(__('Inserted into the post','cmp'), __('Use this iamge','cmp'), $text);
}
